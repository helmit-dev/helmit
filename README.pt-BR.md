...
Criado e mantido por [Alessandro Varela](https://github.com/alessandrovarela).
...
Ajustes claros, localizados e diretamente verificáveis (incluindo labels,
cache e bugs de causa conhecida) seguem por edição e conferência, sem nova
tarefa ou artefato. Use um registro `CHG-NNN` quando investigação, decisões,
coordenação ou continuidade precisam de acompanhamento; use uma entrega para
um compromisso maior de produto.
