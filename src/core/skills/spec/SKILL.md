...
When the authorized outcome is maintenance, copy, configuration, or a limited
restoration of behavior already promised, keep it out of the delivery roadmap.
...
- Do not create a flat chart here. Corrections use the CHG route; deliveries
...
- Do NOT produce charts or tasks; planning belongs to the planning/execution
  capability, and localized corrections use CHG.
