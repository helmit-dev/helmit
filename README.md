...
Created and maintained by [Alessandro Varela](https://github.com/alessandrovarela).
...
Clear, localized, directly verifiable adjustments (including field labels,
cache ignores and known-cause fixes) use ordinary edits and checks, without
a new task or artifact. Use a bounded `CHG-NNN` record when investigation,
decisions, coordination or continuity need tracking; use a delivery for a
larger product commitment.
